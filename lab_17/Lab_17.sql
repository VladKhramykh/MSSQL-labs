...
--4
insert into STUDENT(IDGROUP, NAME, BDAY, INFO) values(22, 'Храмых. В.О.', '01.05.1999',
                                                          '<студент>
...
select * from STUDENT where NAME = 'Храмых В.О.';
...
select Name, INFO from STUDENT where NAME='Храмых В.О.'
