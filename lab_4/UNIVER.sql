create database KVO_UNIVER
on primary
( name = FACULTY, filename =  N'G:\УЧЁБА\SQL_Labs\lab_4\KVO_FACULTY.mdf', 
   size = 5Mb, maxsize=10Mb, filegrowth=1Mb),
( name = AUDITORIUM_TYPE, filename = N'G:\УЧЁБА\SQL_Labs\lab_4\KVO_AUDITORIUM_TYPE.ndf', 
   size = 5Mb, maxsize=10Mb ,filegrowth=10%),
( name = PROFESSION, filename = N'G:\УЧЁБА\SQL_Labs\lab_4\KVO_PROFESSION.ndf', 
   size = 5Mb, maxsize=10Mb ,filegrowth=10%),
filegroup G1
( name = PULPIT, filename = N'G:\УЧЁБА\SQL_Labs\lab_4\KVO_PULPIT.ndf', 
   size = 10Mb, maxsize=15Mb, filegrowth=1Mb),
( name = SUBJECT, filename = N'G:\УЧЁБА\SQL_Labs\lab_4\KVO_SUBJECT.ndf', 
   size = 2Mb, maxsize=5Mb, filegrowth=1Mb),
( name = GROUPS, filename = N'G:\УЧЁБА\SQL_Labs\lab_4\KVO_GROUPS.ndf', 
   size = 2Mb, maxsize=5Mb, filegrowth=1Mb),
(name = TEACHER, filename = N'G:\УЧЁБА\SQL_Labs\lab_4\KVO_TEACHER.ndf', 
   size = 2Mb, maxsize=5Mb, filegrowth=1Mb),
filegroup G2
( name = AUDITORIUM, filename = N'G:\УЧЁБА\SQL_Labs\lab_4\KVO_UNIVER21.ndf', 
   size = 5Mb, maxsize=10Mb, filegrowth=1Mb)
log on
( name = N'KVO_UNIVER_log', filename=N'G:\УЧЁБА\SQL_Labs\lab_4\KVO_UNIVER122.ldf',       
